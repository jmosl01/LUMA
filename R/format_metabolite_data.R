...
#' @return mSetObj
format_MetabolomicData <- function(mSetObj, Peak.list, Sample.df, Sample.data)
{
...
#' @export
format_MetabolomicData.pktable <- function(mSetObj, Peak.list, Sample.df, Sample.data)
{
  ##-----------------------------------------------------------------------------------------
...
#' @rdname format_MetabolomicData
#' @export
format_MetabolomicData.mass_all <- function(mSetObj, Peak.list, Sample.df, Sample.data)
{
...
#' @rdname format_MetabolomicData
#' @export
format_MetabolomicData.default <- function(mSetObj, Peak.list, Sample.df, Sample.data)
{
...
{
  UseMethod("output_MetabolomicData", mSetObj)
}
