...
CullBackground <- function(from.tables,to.tables,method,db.list,db.dir,new.db,lib.db) {
  ...
  Peak.list <- remove_background_peaks(Peak.list = NULL,
                                       Sample.df = data.frame(Sex = Sex,
                                                              Class = Class,
                                                              n = no.Samples,
                                       ...
                                       db.dir = db.dir,
                                       new.db = new.db)
  peak_db <<- connect_peakdb(file.base = new.db,db.dir = db.dir)
  ...
  peak.db <- connect_peakdb(file.base = "Peaklist")
