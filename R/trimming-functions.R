...
#' @param method which method to use.  See usage for details
...
remove_void_volume = function(Peak.list, search.par,method) {
    ...
    class(method) <- method
    Peak.list.trimmed <- trim_rt(method,Peak.list,rt.list,void.rt)
...
#' @return NULL
trim_rt <- function(object,Peak.list, rt.list, void.rt) {
  UseMethod("trim_rt", object)
}

#' @rdname trim_rt
#' @export
trim_rt.mz <- function(object,Peak.list,rt.list,void.rt) {
...
#' @rdname trim_rt
#' @export
trim_rt.monoMass  <- function(object,Peak.list,rt.list,void.rt) {
